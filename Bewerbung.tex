...
\parbox[][0.11\textheight][c]{\linewidth}{ % Box to hold your name and CV title; change the fixed height as needed to match the colored box to the right
	...
	{\sffamily\Huge Malte Rill} % Your name
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Name}{\textbf{Malte Rill}}{spaceafter}
	\tableentry{Geboren am}{19.08.2007}{}
	\tableentry{Anschrift}{Ginsterweg 2}{}
	\tableentry{}{95028 Hof an der Saale}{}
	\tableentry{E-Mail}{ma99@family-rill.de}{}
...
\jobentry
{31.07.23-04.08.23	\break 04.09.23-08.09.23} % Duration
{} % FT/PT (full time or part time)
{} % Employer
{Ferienjob} % Job title
{bei Medika im Lager} % Description

%------------------------------------------------

\jobentry
{14.03.22-18.03.22} % Duration
{} % FT/PT (full time or part time)
{} % Employer
{Praktikum} % Job title
{bei Bitzinger eine Webseite erstellt} % Description
...
{} % FT/PT (full time or part time)
{} % Employer
{Coding Cids} % Job title
{Erklärung von Scratch für 4. Klässler} % Description
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\qualificationentry
	{Sep 2017 - jetzt} % Duration
	{11. Jahrgangsstufe} % Degree
	{} % Honors, achievements or distinctions (e.g. first class honors)
	{} % Department
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Sehr Gut}{Deutsch (Muttersprache)}{}

	\tableentry{}{Englisch (C1+),}{spaceafter}



	\tableentry{GUT}{Python, Swift,}{}
	...
	\tableentry{Ausreichend}{Kotlin, Flutter, Bash}{}
